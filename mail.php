<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // access
        $secretKey = '6LffbK0cAAAAAAG1jK_nibSSBxJjEc9WYEijyXfw';
        ...
        $mail_to = "well_iam_king@yahoo.com, david123beauchamp@gmail.com";
        ...
        $subject = 'Message from Sebastopol Sharks site visitor ' . $name;
